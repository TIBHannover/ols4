	...
	properties.putAll(searchProperties);
        ...
        return new ResponseEntity<>(
                new V2PagedAndFacetedResponse<V2Entity>(
                    classRepository.find(pageable, lang, search, searchFields, boostFields, exactMatch, DynamicQueryHelper.filterProperties(properties),schemas,classifications,ontologies,exclusive,filterOption, outputOpts)
                    .map(V2Entity::new)
                ),
                HttpStatus.OK
        );
