    ...
    public HttpEntity<V2PagedAndFacetedResponse<V2Entity>> getIndividuals(
        ...
        return new ResponseEntity<>(
                new V2PagedAndFacetedResponse<V2Entity>(
                    individualRepository.find(pageable, lang, search, searchFields, boostFields, exactMatch, DynamicQueryHelper.filterProperties(properties),schemas,classifications,ontologies,exclusive,filterOption, outputOpts).map(V2Entity::new)
                ),
                HttpStatus.OK);
    }
