    ...
    public HttpEntity<V2PagedAndFacetedResponse<V2Entity>> getEntities(
        ...
        return new ResponseEntity<>(
                new V2PagedAndFacetedResponse<V2Entity>(
                    entityRepository.find(pageable, lang, search, searchFields, boostFields, facetFields, exactMatch, DynamicQueryHelper.filterProperties(properties), schemas,classifications,ontologies,exclusive,filterOption, outputOpts) .map(V2Entity::new)
                        ),
                    HttpStatus.OK);
    }
