...
@Component
public class ClassRepository extends OntologyRepository {
    ...
    public OlsFacetedResultsPage<JsonElement> find(
            ...
            Collection<String> schemas, Collection<String> classifications, Collection<String> ontologies, boolean exclusive, FilterOption filterOption, JsonTransformOptions outputOpts
