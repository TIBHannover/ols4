...
@Component
public class EntityRepository extends OntologyRepository {
    ...
    public OlsFacetedResultsPage<JsonElement> find(
            Pageable pageable, String lang, String search, String searchFields, String boostFields, String facetFields, boolean exactMatch, Map<String, Collection<String>> properties,
            Collection<String> schemas, Collection<String> classifications, Collection<String> ontologies, boolean exclusive, FilterOption filterOption, JsonTransformOptions outputOpts) throws IOException {
